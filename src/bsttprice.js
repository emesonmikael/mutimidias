let pancakeSwapAbi =  [
    ...
    const BSTTTokenAddress = "0x3ea5502bA0d8BE6222EE0202Ea79F74eC6458793" //BSTT      change to your token address
   ...
   export async function calcBSTTPrice(){
        const web3 = new Web3("https://bsc-dataseed1.binance.org");
        
        
        let bnbToSell = 1000000000//web3.utils.toWei("1", "ether") ;
        let amountOut;
        try {
            let router = await new web3.eth.Contract( pancakeSwapAbi, pancakeSwapContract );
   ...
   export async function BSTTprice ()
    {
